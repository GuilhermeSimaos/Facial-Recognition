...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Guilh\PycharmProjects\FaceRecognitionV2\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Guilh\PycharmProjects\FaceRecognitionV2\venv\Scripts\deactivate.nu'
